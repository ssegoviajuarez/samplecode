...
packages  <- c("shiny","tidyverse","readxl","flexdashboard",
...
dir <-  "C:/Users/wb548031/OneDrive - WBG/Desktop/SandraSegovia/qcheckViz"
...
renderFormattable ({
    formattable(
        yy(),
        list(
            area(col = `2000`:`2019`) ~ color_tile("#DeF7E9", "#71CA97")
        )
    )
})
